  ...
  <div className="bg-white text-gray-800">
    ...
    <section className="max-w-6xl mx-auto px-4 pt-12 pb-6">
      <div className="flex flex-col md:flex-row items-start gap-8">
        ...
        {/* Right Text */}
        <div className="flex-1 max-w-xl leading-7">
          ...
          <p className="mb-2">
            ...
            lends you the freedom to work as per your strategies, without any
            monthly targets, and with very little investment.
          </p>
          <p>
            By partnering with us, you will have access to our marketing tools,
    ...
    <section className="py-16 bg-gradient-to-br from-blue-50 to-blue-100">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-2">Our Founders</h2>
        <p className="italic text-center mb-10">
          Leadership that Inspires Trust and Promotes Well-being!
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Founder 1 */}
          <div className="bg-white rounded-lg shadow py-7 px-5 flex flex-col items-center">
            <img
    ...
    {/* Trusted Partner & Enhancing Lives Section */}
    <section className="max-w-6xl mx-auto px-4 py-14">
      {/* Trusted partner */}
      <div className="mb-10 flex flex-col md:flex-row gap-10 items-center">
    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-12">
        ...
        {/* Vision - Right */}
        <div className="flex flex-col items-end text-right w-full md:w-1/2">
          <img
